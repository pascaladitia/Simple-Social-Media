...
import com.pascal.udacodingpagging3.databinding.ItemPostBinding
import com.pascal.udacodingpagging3.model.ResponseListPost

class PostAdapter(val context: Context, private val list: (ResponseListPost) -> Unit) :
    PagingDataAdapter<ResponseListPost, PostAdapter.PostHolder>(PostDiffUtil()) {
    ...
    inner class PostHolder(var binding: ItemPostBinding) : RecyclerView.ViewHolder(binding.root) {
